...
//! the consuming application's test doubles.

use async_trait::async_trait;

use crate::{DeviceConfig, InputGain, OutputGain, QA40xDevice, SampleRate, Telemetry};
...
impl Analyzer for QA40xDevice {
    ...
    async fn set_sample_rate(&self, rate: SampleRate) -> Result<(), DeviceError> {
        QA40xDevice::set_sample_rate(self, rate)
            .await
